...
**Note**: The above exmaple with ``manual_spawning_python`` is
currently disabled, see issue `#5627 <https://github.com/dask/distributed/issues/5627>`_
with with ``dask.distributed``.
