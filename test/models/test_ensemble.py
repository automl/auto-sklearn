...
import autosklearn.scripts.ensemble_script
...
class Test(unittest.TestCase):
    ...
    def test_weighted_ensemble(self):
        ...
        weights = autosklearn.scripts.ensemble_script.weighted_ensemble(std_print,
    ...
    def test_ensemble_prediction(self):
        ...
        p_hat = autosklearn.scripts.ensemble_script.ensemble_prediction(pred, w)
        p = pred.mean(axis=0)
    ...
    def test_weighted_ensemble_error(self):
        ...
        err = autosklearn.scripts.ensemble_script.weighted_ensemble_error(
