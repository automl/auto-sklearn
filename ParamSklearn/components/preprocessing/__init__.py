...
class PreprocessorChoice(object):
    ...
    def get_available_components(cls, data_prop,
        ...
        for name in available_comp:
            ...
            if entry == PreprocessorChoice or hasattr(entry, 'get_components'):
                continue
        ...
        always_active = ["imputation", "rescaling", "balancing"]
        components_dict = {key: value for key, value
                           in components_dict.items()
                           if key not in always_active}
...
_preprocessors['preprocessor'] = PreprocessorChoice