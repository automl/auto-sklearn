...
class SparseFiltering(object):
    ...
    def step(self, X, W):
        ...
        deltaW = l2rowg(features_norm, feautres_row, row_norm, np.ones(features_row.shape))
        deltaW = l2rowg(features_norm.T, features_column, column_norm, deltaW.T)
    ...
    def fit(self, X, y=None):
        ...
        self.W = res.x.reshape(X.shape[1], N)
